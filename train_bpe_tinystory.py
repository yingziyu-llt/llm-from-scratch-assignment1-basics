...
# 1. 定义路径和参数
input_data_path = "assignment1-data/TinyStoriesV2-GPT4-train.txt" # 替换为你本地数据集的实际路径 
vocab_size = 10000 # 作业要求的词表大小 [cite: 1116]
special_tokens = ["<|endoftext|>"] # 必须添加的特殊 token 
output_dir = "models/tokenizer_tinystories"
...
import cProfile
cProfile.run('train_tokenizer(input_data_path, vocab_size, special_tokens)', 'train_bpe_tinystory.prof')
